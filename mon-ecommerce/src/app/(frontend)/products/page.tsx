  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">Chaussures Homme</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Page Title */}
        <h1 className="text-3xl font-bold text-gray-900 mb-6">CHAUSSURES HOMME</h1>

        <div className="flex gap-8">
          {/* Sidebar - Filtres */}
          <div className="w-64 flex-shrink-0">
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Affiner Les Résultats</h2>

              {/* Clear Filters */}
              <button
                onClick={clearAllFilters}
                className="text-sm text-blue-600 hover:text-blue-800 mb-6 flex items-center"
              >
