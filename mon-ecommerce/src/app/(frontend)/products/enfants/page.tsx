...
import { ChevronRight, Home, Filter, X, Search, ChevronUp, ChevronDown, ArrowRight } from 'lucide-react'
...
export default function EnfantsProductsPage() {
  ...
  useEffect(() => {
    const fetchFilterData = async () => {
      try {
        const response = await fetch('/api/filters?category=enfants')
  ...
  // Récupérer les produits enfants avec filtres
  useEffect(() => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Page Title */}
          <h1 className="text-3xl font-bold text-gray-900 mb-8">Chaussures Enfants</h1>
