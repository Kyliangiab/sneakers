#!/usr/bin/env python3
"""
Script pour mettre à jour les stocks des produits via l'API
"""
...
class StockUpdaterAPI:
    ...
    def update_all_stocks(self):
        ...
        for i, product in enumerate(products):
            ...
            print(f"🔄 [{i+1}/{len(products)}] {product_title[:50]}... -> Stock: {stock_value}")
